...
function build_dt_cmd() {
    ...
    do
        ...
        OUT_DIR=../${RELATIVE_KERNEL_OBJ} BUILD_CONFIG=../${RELATIVE_KERNEL_OBJ}/build.config GOALS=dtbs ./build_kernel.sh mediatek/${dtb}.dtb
    ...
    do
        ...
        OUT_DIR=../${RELATIVE_KERNEL_OBJ} BUILD_CONFIG=../${RELATIVE_KERNEL_OBJ}/build.config GOALS=dtbs ./build_kernel.sh mediatek/${dtbo}.dtb
    done
